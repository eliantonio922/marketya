                  ...
                  <div class="card">
                      ...
                      <div class="card-body">
                          <table id="example2" class="table table-bordered table-hover">
                              ...
                              <tbody>
                                  <?php
                                    $query = "SELECT id,nombre, precio, existencia, imagen from productos;  ";
                                    $res = mysqli_query($con, $query);
                                    ...
                                    ?>
                                      <tr>
                                          ...
                                          <td><img src="<?php echo $row['imagen'] ?>" alt="" style="height: 150px ; object-dit; contain"></td>

                                          <td>
                                              <a href="panel.php?modulo=editarProducto&id=<?php echo $row['id'] ?>" style="margin-right: 15px;"> <i class="fas fa-edit"></i> </a>
