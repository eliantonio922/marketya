$(document).ready(function () {
    ...
    function llenarTablaCarrito(response){
        ...
        response.forEach(element => {
            ...
            $("#tablaCarrito tbody").append(
                `
                <tr>
                    <td><img src="${element['imagen']}" class="img-size-50"/></td>
    ...
    $("#agregarCarrito").click(function (e) { 
        ...
        $.ajax({
            ...
            data: {"id":id,"nombre":nombre,"imagen":imagen,"cantidad":cantidad,"precio":precio},
            dataType: "json",
            success: function (response) {
                llenaCarrito(response);
        ...
        response.forEach(element => {
            $("#listaCarrito").append(
                ...
                <a href="index.php?modulo=detalleproducto&id=${element['id']}" class="dropdown-item">
                    <!-- Message Start -->
                    <div class="media">
                        <img src="${element['imagen']}" class="img-size-50 mr-3 img-circle">
